...
The Babylon node code is released under the [Radix License](LICENSE). The runtime is licensed under the [Radix Node EULA](http://www.radixdlt.com/terms/nodeEULA).
