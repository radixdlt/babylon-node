...
public final class UserTransactionMoratoriumVerifierTest {
  ...
  private static final Round ROUND = Round.of(5);
  ...
  @Test
  public void rejects_proposal_carrying_user_transactions_while_moratorium_is_in_force() {
    // Arrange
    final var verifier = createVerifier(Result.error(MORATORIUM));
    final var proposal =
  ...
  @Test
  public void forwards_proposal_without_user_transactions_while_moratorium_is_in_force() {
    // Arrange
    final var verifier = createVerifier(Result.error(MORATORIUM));
    final var proposal = createProposal(List.of());
  ...
  @Test
  public void forwards_proposal_carrying_user_transactions_when_no_moratorium_is_in_force() {
    // Arrange
  ...
  private Proposal createProposal(List<RawNotarizedTransaction> transactions) {
    // Logging must be able to render the fake validator ID.
    final var address =
