...
public final class BrowseObjectCollectionIteratorTest extends DeterministicBrowseApiTestBase {
  ...
  public void browse_api_object_collection_iterator_pages_through_all_entries() throws Exception {
    try (var test = buildRunningServerTest()) {
      ...
      final var allKeys = getObjectsApi().objectCollectionIteratorPost(request).getPage();
