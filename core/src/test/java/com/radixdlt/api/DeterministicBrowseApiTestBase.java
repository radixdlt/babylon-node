...
import com.radixdlt.api.browse.generated.api.*;
...
public abstract class DeterministicBrowseApiTestBase {
  ...
  private final int browseApiPort;

  private final ApiClient apiClient;

  private final int coreApiPort;

  protected DeterministicBrowseApiTestBase() {
    this.browseApiPort = FreePortFinder.findFreeLocalPort();
  ...
  protected DeterministicTest buildRunningServerTest(
    ...
    var test =
        DeterministicTest.builder()
            ...
            .addModule(new BrowseApiServerModule("127.0.0.1", browseApiPort))
            .addModule(
                new AbstractModule() {
                  @ProvidesIntoSet
                  private StartProcessorOnRunner startBrowseApi(BrowseApiServer browseApiServer) {
