...
public final class LtsAccountBalanceTestV0 extends DeterministicCoreApiTestBase {
  @Test
    ...
    try (var test = buildRunningServerTest()) {
      ...
      var faucetClaim =
          submitAndWaitForSuccess(
              test,
              constructDepositFromFaucetManifest(networkDefinition, accountAddress),
              List.of());
  ...
  public LtsTransactionOutcomesTest.CommittedResult submitAndWaitForSuccess(
