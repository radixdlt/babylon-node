...
public class SimulationNetworkModule extends AbstractModule {
  ...
  protected void configure() {
    Multibinder.newSetBinder(
        binder(), new TypeLiteral<Predicate<SimulationNetwork.MessageInTransit>>() {});
    MapBinder.newMapBinder(
        binder(),
        new TypeLiteral<Class<?>>() {},
        new TypeLiteral<
            Function<SimulationNetwork.MessageInTransit, SimulationNetwork.MessageInTransit>>() {});
  ...
  private LatencyProvider latencyProvider(
      ...
      Set<Predicate<SimulationNetwork.MessageInTransit>> droppers) {
    return msg -> {
