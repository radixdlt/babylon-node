...
public final class MockedMempoolStateComputer implements StateComputer {
  ...
  private final Mempool<RawNotarizedTransaction, RawNotarizedTransaction> mempool;
  ...
  public List<RawNotarizedTransaction> getTransactionsForProposal(
    ...
    return this.mempool.getTransactionsForProposal(1, Integer.MAX_VALUE, List.of());
  }
