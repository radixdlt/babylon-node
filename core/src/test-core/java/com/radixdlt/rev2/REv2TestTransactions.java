...
public final class REv2TestTransactions {
  ...
  public static String constructCreateNonFungibleResourceManifest(
      NetworkDefinition networkDefinition, ComponentAddress account) {
  ...
  public static String constructDoubleMintSingleBurnManifest(
      NetworkDefinition networkDefinition, ComponentAddress account, ResourceAddress resource) {
    final var addressing = Addressing.ofNetwork(networkDefinition);
    final var accountAddress = addressing.encodeAccountAddress(account);
  ...
  public static String constructDepositFromAccountManifest(
      NetworkDefinition networkDefinition, ComponentAddress faucet, ComponentAddress from) {
