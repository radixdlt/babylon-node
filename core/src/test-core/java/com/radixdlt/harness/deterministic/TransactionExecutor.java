...
public final class TransactionExecutor {
  ...
  /**
   * Executes the given transaction (by placing it directly in one Node's mempool), waits until it
   * is committed, and returns its execution details (by querying all Nodes' database until found).
   */
  public static TransactionDetails executeTransaction(
  ...
  /**
   * A convenience method: finalizes the build of the given transaction and {@link
   * #executeTransaction(DeterministicTest, RawNotarizedTransaction) executes} it.
   */
  public static TransactionDetails executeTransaction(
      DeterministicTest test, TransactionBuilder transactionBuilder) {
    return executeTransaction(test, transactionBuilder.prepare().raw());
  }
}
