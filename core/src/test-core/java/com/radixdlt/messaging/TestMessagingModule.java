...
public class TestMessagingModule extends AbstractModule {

  private final TestMessagingModule.Builder builder;

  private TestMessagingModule(TestMessagingModule.Builder builder) {
  ...
  public static class Builder {
    ...
    public TestMessagingModule.Builder withDefaultRateLimit() {
      this.rateLimiter = RateLimiter.create(50.0);
      return this;
    }

    public TestMessagingModule.Builder withRateLimit(double permitsPerSecond) {
      this.rateLimiter = RateLimiter.create(permitsPerSecond);
      return this;
    }

    public TestMessagingModule build() {
      return new TestMessagingModule(this);
    }
