...
/**
 * Details related to the objects blueprint, initialized during instantiation. Not available for uninstantiated objects. 
 */
@ApiModel(description = "Details related to the objects blueprint, initialized during instantiation. Not available for uninstantiated objects. ")
@JsonPropertyOrder({
  ResolvedBlueprintInfo.JSON_PROPERTY_OUTER_OBJECT_ADDRESS,
  ResolvedBlueprintInfo.JSON_PROPERTY_ENABLED_FEATURES,
  ResolvedBlueprintInfo.JSON_PROPERTY_SUBSTITUTED_GENERIC_TYPES
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ResolvedBlueprintInfo {
  ...
  public ResolvedBlueprintInfo() { 
  }

  public ResolvedBlueprintInfo outerObjectAddress(String outerObjectAddress) {
  ...
  **/
  ...
  public ResolvedBlueprintInfo enabledFeatures(List<String> enabledFeatures) {
    this.enabledFeatures = enabledFeatures;
    return this;
  }

  public ResolvedBlueprintInfo addEnabledFeaturesItem(String enabledFeaturesItem) {
  ...
  **/
  ...
  public ResolvedBlueprintInfo substitutedGenericTypes(List<ResolvedTypeReference> substitutedGenericTypes) {
    this.substitutedGenericTypes = substitutedGenericTypes;
    return this;
  }

  public ResolvedBlueprintInfo addSubstitutedGenericTypesItem(ResolvedTypeReference substitutedGenericTypesItem) {
  ...
  **/
  ...
  /**
   * Return true if this ResolvedBlueprintInfo object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ResolvedBlueprintInfo resolvedBlueprintInfo = (ResolvedBlueprintInfo) o;
    return Objects.equals(this.outerObjectAddress, resolvedBlueprintInfo.outerObjectAddress) &&
        Objects.equals(this.enabledFeatures, resolvedBlueprintInfo.enabledFeatures) &&
        Objects.equals(this.substitutedGenericTypes, resolvedBlueprintInfo.substitutedGenericTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResolvedBlueprintInfo {\n");
