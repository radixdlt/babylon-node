...
public class GenericKeyValueStoreSubstate extends Substate {
  ...
  **/
  ...
  public GenericKeyValueStoreSubstate keyNonFungibleLocalId(NonFungibleLocalId keyNonFungibleLocalId) {
  ...
  **/
  ...
  /**
   * Return true if this GenericKeyValueStoreSubstate object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(GenericKeyValueStoreSubstate.class, "substate_type", mappings);
}
}
