...
public class LedgerTransaction extends AbstractOpenApiSchema {
        ...
        public LedgerTransaction deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            switch (discriminatorValue) {
                ...
                case "ValidatorLedgerTransaction":
                    ...
                    return newLedgerTransaction;
                default:
                    log.log(Level.WARNING, String.format("Failed to lookup discriminator value `%s` for LedgerTransaction. Possible values: User UserLedgerTransaction Validator ValidatorLedgerTransaction", discriminatorValue));
            }
     ...
     * UserLedgerTransaction, ValidatorLedgerTransaction
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be UserLedgerTransaction, ValidatorLedgerTransaction");
    }
     ...
     * UserLedgerTransaction, ValidatorLedgerTransaction
     *
     * @return The actual instance (UserLedgerTransaction, ValidatorLedgerTransaction)
     */
    @Override
