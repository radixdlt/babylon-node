...
public class NextEpoch {
  ...
  **/
  ...
  public NextEpoch validators(List<ValidatorEntry> validators) {
    this.validators = validators;
    return this;
  }

  public NextEpoch addValidatorsItem(ValidatorEntry validatorsItem) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_VALIDATORS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setValidators(List<ValidatorEntry> validators) {
    this.validators = validators;
  }
