...
import com.radixdlt.api.core.generated.models.PackageTypePointerAllOf;
 ...
 */
@JsonPropertyOrder({
  PackageTypePointer.JSON_PROPERTY_SCHEMA_HASH,
  PackageTypePointer.JSON_PROPERTY_LOCAL_TYPE_INDEX
})
...
public class PackageTypePointer extends TypePointer {
  ...
  public PackageTypePointer() { 
  }

  public PackageTypePointer schemaHash(String schemaHash) {
  ...
  **/
  ...
  public PackageTypePointer localTypeIndex(LocalTypeIndex localTypeIndex) {
  ...
  **/
  ...
  /**
   * Return true if this PackageTypePointer object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PackageTypePointer packageTypePointer = (PackageTypePointer) o;
    return Objects.equals(this.schemaHash, packageTypePointer.schemaHash) &&
        Objects.equals(this.localTypeIndex, packageTypePointer.localTypeIndex) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemaHash, localTypeIndex, super.hashCode());
  }
...
static {
  ...
  JSON.registerDiscriminator(PackageTypePointer.class, "pointer_type", mappings);
}
}
