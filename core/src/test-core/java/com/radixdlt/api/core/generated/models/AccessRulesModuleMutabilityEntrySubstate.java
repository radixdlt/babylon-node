...
import com.radixdlt.api.core.generated.models.AccessRulesModuleMutabilityEntrySubstateAllOf;
 ...
 */
@JsonPropertyOrder({
  AccessRulesModuleMutabilityEntrySubstate.JSON_PROPERTY_OBJECT_MODULE_ID,
  AccessRulesModuleMutabilityEntrySubstate.JSON_PROPERTY_ROLE_KEY,
  AccessRulesModuleMutabilityEntrySubstate.JSON_PROPERTY_MUTABLE_ROLE_KEYS
})
...
public class AccessRulesModuleMutabilityEntrySubstate extends Substate {
  ...
  public static final String JSON_PROPERTY_MUTABLE_ROLE_KEYS = "mutable_role_keys";
  private List<String> mutableRoleKeys = null;

  public AccessRulesModuleMutabilityEntrySubstate() { 
  }

  public AccessRulesModuleMutabilityEntrySubstate objectModuleId(ObjectModuleId objectModuleId) {
  ...
  **/
  ...
  public AccessRulesModuleMutabilityEntrySubstate roleKey(String roleKey) {
  ...
  **/
  ...
  public AccessRulesModuleMutabilityEntrySubstate mutableRoleKeys(List<String> mutableRoleKeys) {
    this.mutableRoleKeys = mutableRoleKeys;
    return this;
  }

  public AccessRulesModuleMutabilityEntrySubstate addMutableRoleKeysItem(String mutableRoleKeysItem) {
    if (this.mutableRoleKeys == null) {
      this.mutableRoleKeys = new ArrayList<>();
    }
    this.mutableRoleKeys.add(mutableRoleKeysItem);
    return this;
  }

   /**
   * Get mutableRoleKeys
   * @return mutableRoleKeys
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")
  @JsonProperty(JSON_PROPERTY_MUTABLE_ROLE_KEYS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public List<String> getMutableRoleKeys() {
    return mutableRoleKeys;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MUTABLE_ROLE_KEYS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMutableRoleKeys(List<String> mutableRoleKeys) {
    this.mutableRoleKeys = mutableRoleKeys;
  }


  /**
   * Return true if this AccessRulesModuleMutabilityEntrySubstate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AccessRulesModuleMutabilityEntrySubstate accessRulesModuleMutabilityEntrySubstate = (AccessRulesModuleMutabilityEntrySubstate) o;
    return Objects.equals(this.objectModuleId, accessRulesModuleMutabilityEntrySubstate.objectModuleId) &&
        Objects.equals(this.roleKey, accessRulesModuleMutabilityEntrySubstate.roleKey) &&
        Objects.equals(this.mutableRoleKeys, accessRulesModuleMutabilityEntrySubstate.mutableRoleKeys) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(objectModuleId, roleKey, mutableRoleKeys, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AccessRulesModuleMutabilityEntrySubstate {\n");
    ...
    sb.append("    mutableRoleKeys: ").append(toIndentedString(mutableRoleKeys)).append("\n");
    sb.append("}");
    return sb.toString();
  }
...
static {
  ...
  JSON.registerDiscriminator(AccessRulesModuleMutabilityEntrySubstate.class, "substate_type", mappings);
}
}
