...
import com.radixdlt.api.core.generated.models.OneResourcePoolSubstateAllOf;
 ...
 */
@JsonPropertyOrder({
  OneResourcePoolSubstate.JSON_PROPERTY_VAULT,
  OneResourcePoolSubstate.JSON_PROPERTY_POOL_UNIT_RESOURCE_ADDRESS
})
...
public class OneResourcePoolSubstate extends Substate {
  ...
  public OneResourcePoolSubstate() { 
  }

  public OneResourcePoolSubstate vault(EntityReference vault) {
    this.vault = vault;
    return this;
  }
  ...
  **/
  ...
  public OneResourcePoolSubstate poolUnitResourceAddress(String poolUnitResourceAddress) {
  ...
  **/
  ...
  /**
   * Return true if this OneResourcePoolSubstate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OneResourcePoolSubstate oneResourcePoolSubstate = (OneResourcePoolSubstate) o;
    return Objects.equals(this.vault, oneResourcePoolSubstate.vault) &&
        Objects.equals(this.poolUnitResourceAddress, oneResourcePoolSubstate.poolUnitResourceAddress) &&
        super.equals(o);
  }
...
static {
  ...
  JSON.registerDiscriminator(OneResourcePoolSubstate.class, "substate_type", mappings);
}
}
