...
import com.radixdlt.api.core.generated.models.PackageRoyaltySubstateAllOf;
 ...
 */
@JsonPropertyOrder({
  PackageRoyaltySubstate.JSON_PROPERTY_VAULT_ENTITY,
  PackageRoyaltySubstate.JSON_PROPERTY_BLUEPRINT_ROYALTIES
})
...
public class PackageRoyaltySubstate extends Substate {
  ...
  public PackageRoyaltySubstate() { 
  }

  public PackageRoyaltySubstate vaultEntity(EntityReference vaultEntity) {
  ...
  **/
  ...
  public PackageRoyaltySubstate blueprintRoyalties(List<BlueprintRoyaltyConfig> blueprintRoyalties) {
    this.blueprintRoyalties = blueprintRoyalties;
    return this;
  }

  public PackageRoyaltySubstate addBlueprintRoyaltiesItem(BlueprintRoyaltyConfig blueprintRoyaltiesItem) {
  ...
  **/
  ...
  /**
   * Return true if this PackageRoyaltySubstate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PackageRoyaltySubstate packageRoyaltySubstate = (PackageRoyaltySubstate) o;
    return Objects.equals(this.vaultEntity, packageRoyaltySubstate.vaultEntity) &&
        Objects.equals(this.blueprintRoyalties, packageRoyaltySubstate.blueprintRoyalties) &&
        super.equals(o);
  }
...
static {
  ...
  JSON.registerDiscriminator(PackageRoyaltySubstate.class, "substate_type", mappings);
}
}
