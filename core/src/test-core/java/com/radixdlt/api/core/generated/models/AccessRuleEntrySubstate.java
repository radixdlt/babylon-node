...
import com.radixdlt.api.core.generated.models.AccessRuleEntrySubstateAllOf;
 ...
 */
@JsonPropertyOrder({
  AccessRuleEntrySubstate.JSON_PROPERTY_OBJECT_MODULE_ID,
  AccessRuleEntrySubstate.JSON_PROPERTY_ROLE_KEY,
  AccessRuleEntrySubstate.JSON_PROPERTY_ACCESS_RULE
})
...
public class AccessRuleEntrySubstate extends Substate {
  ...
  public AccessRuleEntrySubstate() { 
  }

  public AccessRuleEntrySubstate objectModuleId(ObjectModuleId objectModuleId) {
  ...
  **/
  ...
  public AccessRuleEntrySubstate roleKey(String roleKey) {
  ...
  **/
  ...
  public AccessRuleEntrySubstate accessRule(AccessRule accessRule) {
  ...
  **/
  ...
  /**
   * Return true if this AccessRuleEntrySubstate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AccessRuleEntrySubstate accessRuleEntrySubstate = (AccessRuleEntrySubstate) o;
    return Objects.equals(this.objectModuleId, accessRuleEntrySubstate.objectModuleId) &&
        Objects.equals(this.roleKey, accessRuleEntrySubstate.roleKey) &&
        Objects.equals(this.accessRule, accessRuleEntrySubstate.accessRule) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccessRuleEntrySubstate {\n");
...
static {
  ...
  JSON.registerDiscriminator(AccessRuleEntrySubstate.class, "substate_type", mappings);
}
}
