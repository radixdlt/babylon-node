...
public enum GenericTypeParameterContraints {
  ...
  GenericTypeParameterContraints(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static GenericTypeParameterContraints fromValue(String value) {
    for (GenericTypeParameterContraints b : GenericTypeParameterContraints.values()) {
