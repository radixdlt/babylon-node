...
import com.radixdlt.api.core.generated.models.PackageFieldInfoSubstateAllOf;
 ...
 */
@JsonPropertyOrder({
  PackageFieldInfoSubstate.JSON_PROPERTY_PACKAGE_SCHEMA,
  PackageFieldInfoSubstate.JSON_PROPERTY_DEPENDENT_RESOURCES,
  PackageFieldInfoSubstate.JSON_PROPERTY_DEPENDENT_COMPONENTS
})
...
public class PackageFieldInfoSubstate extends Substate {
  ...
  public PackageFieldInfoSubstate() { 
  }

  public PackageFieldInfoSubstate packageSchema(PackageSchema packageSchema) {
  ...
  **/
  ...
  public PackageFieldInfoSubstate dependentResources(List<String> dependentResources) {
    this.dependentResources = dependentResources;
    return this;
  }

  public PackageFieldInfoSubstate addDependentResourcesItem(String dependentResourcesItem) {
  ...
  **/
  ...
  public PackageFieldInfoSubstate dependentComponents(List<String> dependentComponents) {
    this.dependentComponents = dependentComponents;
    return this;
  }

  public PackageFieldInfoSubstate addDependentComponentsItem(String dependentComponentsItem) {
  ...
  **/
  ...
  /**
   * Return true if this PackageFieldInfoSubstate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PackageFieldInfoSubstate packageFieldInfoSubstate = (PackageFieldInfoSubstate) o;
    return Objects.equals(this.packageSchema, packageFieldInfoSubstate.packageSchema) &&
        Objects.equals(this.dependentResources, packageFieldInfoSubstate.dependentResources) &&
        Objects.equals(this.dependentComponents, packageFieldInfoSubstate.dependentComponents) &&
        super.equals(o);
  }
...
static {
  ...
  JSON.registerDiscriminator(PackageFieldInfoSubstate.class, "substate_type", mappings);
}
}
