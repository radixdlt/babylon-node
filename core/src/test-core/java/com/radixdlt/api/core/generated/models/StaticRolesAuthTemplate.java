 ...
 */
@JsonPropertyOrder({
  StaticRolesAuthTemplate.JSON_PROPERTY_ROLE_SPECIFICATION,
  StaticRolesAuthTemplate.JSON_PROPERTY_ROLES,
  StaticRolesAuthTemplate.JSON_PROPERTY_METHOD_ACCESSIBILITY_MAP
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class StaticRolesAuthTemplate {
  ...
  public StaticRolesAuthTemplate() { 
  }

  public StaticRolesAuthTemplate roleSpecification(RoleSpecification roleSpecification) {
  ...
  **/
  ...
  public StaticRolesAuthTemplate roles(Map<String, RoleDetails> roles) {
    this.roles = roles;
    return this;
  }

  public StaticRolesAuthTemplate putRolesItem(String key, RoleDetails rolesItem) {
    if (this.roles == null) {
  ...
  **/
  ...
  public StaticRolesAuthTemplate methodAccessibilityMap(Map<String, MethodAccessibility> methodAccessibilityMap) {
    this.methodAccessibilityMap = methodAccessibilityMap;
    return this;
  }

  public StaticRolesAuthTemplate putMethodAccessibilityMapItem(String key, MethodAccessibility methodAccessibilityMapItem) {
  ...
  **/
  ...
  /**
   * Return true if this StaticRolesAuthTemplate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    StaticRolesAuthTemplate staticRolesAuthTemplate = (StaticRolesAuthTemplate) o;
    return Objects.equals(this.roleSpecification, staticRolesAuthTemplate.roleSpecification) &&
        Objects.equals(this.roles, staticRolesAuthTemplate.roles) &&
        Objects.equals(this.methodAccessibilityMap, staticRolesAuthTemplate.methodAccessibilityMap);
  }
