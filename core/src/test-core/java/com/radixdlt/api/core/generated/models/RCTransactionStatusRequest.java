...
/**
 * RCTransactionStatusRequest
 */
@JsonPropertyOrder({
  RCTransactionStatusRequest.JSON_PROPERTY_NETWORK,
  RCTransactionStatusRequest.JSON_PROPERTY_INTENT_HASH
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class RCTransactionStatusRequest {
  ...
  public RCTransactionStatusRequest() { 
  }

  public RCTransactionStatusRequest network(String network) {
  ...
  **/
  ...
  public RCTransactionStatusRequest intentHash(String intentHash) {
  ...
  **/
  ...
  /**
   * Return true if this RCTransactionStatusRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RCTransactionStatusRequest rcTransactionStatusRequest = (RCTransactionStatusRequest) o;
    return Objects.equals(this.network, rcTransactionStatusRequest.network) &&
        Objects.equals(this.intentHash, rcTransactionStatusRequest.intentHash);
  }
  ...
  public String toString() {
    ...
    sb.append("class RCTransactionStatusRequest {\n");
