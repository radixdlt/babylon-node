...
import com.radixdlt.api.core.generated.models.NonFungibleResourceManagerDataSchemaSubstateAllOf;
 ...
 */
@JsonPropertyOrder({
  NonFungibleResourceManagerDataSchemaSubstate.JSON_PROPERTY_NON_FUNGIBLE_TYPE_INDEX,
  NonFungibleResourceManagerDataSchemaSubstate.JSON_PROPERTY_MUTABLE_FIELDS
})
...
public class NonFungibleResourceManagerDataSchemaSubstate extends Substate {
  public static final String JSON_PROPERTY_NON_FUNGIBLE_TYPE_INDEX = "non_fungible_type_index";
  private LocalTypeIndex nonFungibleTypeIndex;

  public static final String JSON_PROPERTY_MUTABLE_FIELDS = "mutable_fields";
  private List<String> mutableFields = new ArrayList<>();

  public NonFungibleResourceManagerDataSchemaSubstate() { 
  }

  public NonFungibleResourceManagerDataSchemaSubstate nonFungibleTypeIndex(LocalTypeIndex nonFungibleTypeIndex) {
    this.nonFungibleTypeIndex = nonFungibleTypeIndex;
    return this;
  }

   /**
   * Get nonFungibleTypeIndex
   * @return nonFungibleTypeIndex
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(JSON_PROPERTY_NON_FUNGIBLE_TYPE_INDEX)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)

  public LocalTypeIndex getNonFungibleTypeIndex() {
    return nonFungibleTypeIndex;
  }
  ...
  @JsonProperty(JSON_PROPERTY_NON_FUNGIBLE_TYPE_INDEX)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setNonFungibleTypeIndex(LocalTypeIndex nonFungibleTypeIndex) {
    this.nonFungibleTypeIndex = nonFungibleTypeIndex;
  }


  public NonFungibleResourceManagerDataSchemaSubstate mutableFields(List<String> mutableFields) {
    this.mutableFields = mutableFields;
    return this;
  }

  public NonFungibleResourceManagerDataSchemaSubstate addMutableFieldsItem(String mutableFieldsItem) {
  ...
  **/
  ...
  /**
   * Return true if this NonFungibleResourceManagerDataSchemaSubstate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NonFungibleResourceManagerDataSchemaSubstate nonFungibleResourceManagerDataSchemaSubstate = (NonFungibleResourceManagerDataSchemaSubstate) o;
    return Objects.equals(this.nonFungibleTypeIndex, nonFungibleResourceManagerDataSchemaSubstate.nonFungibleTypeIndex) &&
        Objects.equals(this.mutableFields, nonFungibleResourceManagerDataSchemaSubstate.mutableFields) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nonFungibleTypeIndex, mutableFields, super.hashCode());
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NonFungibleResourceManagerDataSchemaSubstate {\n");
    sb.append("    ").append(toIndentedString(super.toString())).append("\n");
    sb.append("    nonFungibleTypeIndex: ").append(toIndentedString(nonFungibleTypeIndex)).append("\n");
...
static {
  ...
  JSON.registerDiscriminator(NonFungibleResourceManagerDataSchemaSubstate.class, "substate_type", mappings);
}
}
