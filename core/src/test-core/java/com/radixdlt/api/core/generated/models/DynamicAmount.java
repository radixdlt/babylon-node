 ...
 */
@JsonPropertyOrder({
  DynamicAmount.JSON_PROPERTY_TYPE
})
...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = AmountDynamicAmount.class, name = "AmountDynamicAmount"),
  @JsonSubTypes.Type(value = SchemaPathDynamicAmount.class, name = "SchemaPath"),
  @JsonSubTypes.Type(value = SchemaPathDynamicAmount.class, name = "SchemaPathDynamicAmount"),
})
...
public class DynamicAmount {
  ...
  public DynamicAmount type(DynamicAmountType type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this DynamicAmount object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DynamicAmount dynamicAmount = (DynamicAmount) o;
    return Objects.equals(this.type, dynamicAmount.type);
  }
