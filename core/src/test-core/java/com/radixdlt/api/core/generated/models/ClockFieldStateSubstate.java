...
import com.radixdlt.api.core.generated.models.ClockFieldStateSubstateAllOf;
 ...
 */
@JsonPropertyOrder({
  ClockFieldStateSubstate.JSON_PROPERTY_TIMESTAMP_ROUNDED_DOWN_TO_MINUTE
})
...
public class ClockFieldStateSubstate extends Substate {
  ...
  public ClockFieldStateSubstate() { 
  }

  public ClockFieldStateSubstate timestampRoundedDownToMinute(Instant timestampRoundedDownToMinute) {
  ...
  **/
  ...
  /**
   * Return true if this ClockFieldStateSubstate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ClockFieldStateSubstate clockFieldStateSubstate = (ClockFieldStateSubstate) o;
    return Objects.equals(this.timestampRoundedDownToMinute, clockFieldStateSubstate.timestampRoundedDownToMinute) &&
        super.equals(o);
  }
...
static {
  ...
  JSON.registerDiscriminator(ClockFieldStateSubstate.class, "substate_type", mappings);
}
}
