...
public class AccessRulesModuleRuleEntrySubstate extends Substate {
  ...
  **/
  ...
  /**
   * Return true if this AccessRulesModuleRuleEntrySubstate object is equal to o.
   */
  @Override
...
static {
  ...
  JSON.registerDiscriminator(AccessRulesModuleRuleEntrySubstate.class, "substate_type", mappings);
}
}
