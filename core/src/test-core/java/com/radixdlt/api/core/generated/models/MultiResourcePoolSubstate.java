...
import com.radixdlt.api.core.generated.models.MultiResourcePoolSubstateAllOf;
 ...
 */
@JsonPropertyOrder({
  MultiResourcePoolSubstate.JSON_PROPERTY_VAULTS,
  MultiResourcePoolSubstate.JSON_PROPERTY_POOL_UNIT_RESOURCE_ADDRESS
})
...
public class MultiResourcePoolSubstate extends Substate {
  ...
  public MultiResourcePoolSubstate() { 
  }

  public MultiResourcePoolSubstate vaults(List<PoolVault> vaults) {
    this.vaults = vaults;
    return this;
  }

  public MultiResourcePoolSubstate addVaultsItem(PoolVault vaultsItem) {
  ...
  **/
  ...
  public MultiResourcePoolSubstate poolUnitResourceAddress(String poolUnitResourceAddress) {
  ...
  **/
  ...
  /**
   * Return true if this MultiResourcePoolSubstate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MultiResourcePoolSubstate multiResourcePoolSubstate = (MultiResourcePoolSubstate) o;
    return Objects.equals(this.vaults, multiResourcePoolSubstate.vaults) &&
        Objects.equals(this.poolUnitResourceAddress, multiResourcePoolSubstate.poolUnitResourceAddress) &&
        super.equals(o);
  }
...
static {
  ...
  mappings.put("MultiResourcePoolSubstate", MultiResourcePoolSubstate.class);
  JSON.registerDiscriminator(MultiResourcePoolSubstate.class, "substate_type", mappings);
}
}
