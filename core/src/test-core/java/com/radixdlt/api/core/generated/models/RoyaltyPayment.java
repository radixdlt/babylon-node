...
@JsonPropertyOrder({
  ...
  RoyaltyPayment.JSON_PROPERTY_XRD_AMOUNT
})
...
public class RoyaltyPayment {
  ...
  **/
  ...
  public RoyaltyPayment xrdAmount(String xrdAmount) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The string-encoded decimal representing the amount of fee in XRD paid as royalty to this receiver. A decimal is formed of some signed integer `m` of attos (`10^(-18)`) units, where `-2^(256 - 1) <= m < 2^(256 - 1)`. ")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.royaltyReceiver, royaltyPayment.royaltyReceiver) &&
        Objects.equals(this.xrdAmount, royaltyPayment.xrdAmount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(royaltyReceiver, xrdAmount);
  }
