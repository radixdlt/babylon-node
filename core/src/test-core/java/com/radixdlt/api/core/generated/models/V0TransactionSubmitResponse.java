 ...
 */
@JsonPropertyOrder({
  V0TransactionSubmitResponse.JSON_PROPERTY_DUPLICATE
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class V0TransactionSubmitResponse {
  public static final String JSON_PROPERTY_DUPLICATE = "duplicate";
  private Boolean duplicate;

  public V0TransactionSubmitResponse() { 
  }

  public V0TransactionSubmitResponse duplicate(Boolean duplicate) {
  ...
  **/
  ...
  /**
   * Return true if this V0TransactionSubmitResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    V0TransactionSubmitResponse v0TransactionSubmitResponse = (V0TransactionSubmitResponse) o;
    return Objects.equals(this.duplicate, v0TransactionSubmitResponse.duplicate);
  }
