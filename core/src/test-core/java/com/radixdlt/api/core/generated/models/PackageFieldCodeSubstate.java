...
import com.radixdlt.api.core.generated.models.PackageFieldCodeSubstateAllOf;
 ...
 */
@JsonPropertyOrder({
  PackageFieldCodeSubstate.JSON_PROPERTY_CODE_HEX
})
...
public class PackageFieldCodeSubstate extends Substate {
  public static final String JSON_PROPERTY_CODE_HEX = "code_hex";
  private String codeHex;

  public PackageFieldCodeSubstate() { 
  }

  public PackageFieldCodeSubstate codeHex(String codeHex) {
  ...
  **/
  ...
  /**
   * Return true if this PackageFieldCodeSubstate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PackageFieldCodeSubstate packageFieldCodeSubstate = (PackageFieldCodeSubstate) o;
    return Objects.equals(this.codeHex, packageFieldCodeSubstate.codeHex) &&
        super.equals(o);
  }
...
static {
  ...
  JSON.registerDiscriminator(PackageFieldCodeSubstate.class, "substate_type", mappings);
}
}
