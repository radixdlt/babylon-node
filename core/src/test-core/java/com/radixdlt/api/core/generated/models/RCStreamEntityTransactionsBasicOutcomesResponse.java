...
/**
 * RCStreamEntityTransactionsBasicOutcomesResponse
 */
@JsonPropertyOrder({
  RCStreamEntityTransactionsBasicOutcomesResponse.JSON_PROPERTY_FROM_STATE_VERSION,
  RCStreamEntityTransactionsBasicOutcomesResponse.JSON_PROPERTY_COUNT,
  RCStreamEntityTransactionsBasicOutcomesResponse.JSON_PROPERTY_MAX_LEDGER_STATE_VERSION,
  RCStreamEntityTransactionsBasicOutcomesResponse.JSON_PROPERTY_BASIC_OUTCOMES
})
@javax.annotation.processing.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class RCStreamEntityTransactionsBasicOutcomesResponse {
  ...
  private List<CommittedTransaction> basicOutcomes = new ArrayList<>();

  public RCStreamEntityTransactionsBasicOutcomesResponse() { 
  }

  public RCStreamEntityTransactionsBasicOutcomesResponse fromStateVersion(Long fromStateVersion) {
  ...
  **/
  ...
  public RCStreamEntityTransactionsBasicOutcomesResponse count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  **/
  ...
  public RCStreamEntityTransactionsBasicOutcomesResponse maxLedgerStateVersion(Long maxLedgerStateVersion) {
  ...
  **/
  ...
  public RCStreamEntityTransactionsBasicOutcomesResponse basicOutcomes(List<CommittedTransaction> basicOutcomes) {
    this.basicOutcomes = basicOutcomes;
    return this;
  }

  public RCStreamEntityTransactionsBasicOutcomesResponse addBasicOutcomesItem(CommittedTransaction basicOutcomesItem) {
  ...
  **/
  ...
  public List<CommittedTransaction> getBasicOutcomes() {
    return basicOutcomes;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BASIC_OUTCOMES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBasicOutcomes(List<CommittedTransaction> basicOutcomes) {
    this.basicOutcomes = basicOutcomes;
  }


  /**
   * Return true if this RCStreamEntityTransactionsBasicOutcomesResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RCStreamEntityTransactionsBasicOutcomesResponse rcStreamEntityTransactionsBasicOutcomesResponse = (RCStreamEntityTransactionsBasicOutcomesResponse) o;
    return Objects.equals(this.fromStateVersion, rcStreamEntityTransactionsBasicOutcomesResponse.fromStateVersion) &&
        Objects.equals(this.count, rcStreamEntityTransactionsBasicOutcomesResponse.count) &&
        Objects.equals(this.maxLedgerStateVersion, rcStreamEntityTransactionsBasicOutcomesResponse.maxLedgerStateVersion) &&
        Objects.equals(this.basicOutcomes, rcStreamEntityTransactionsBasicOutcomesResponse.basicOutcomes);
  }
  ...
  public String toString() {
    ...
    sb.append("class RCStreamEntityTransactionsBasicOutcomesResponse {\n");
