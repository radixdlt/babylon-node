...
import com.radixdlt.api.core.generated.models.CurrentValidatorSetSubstateAllOf;
 ...
 */
@JsonPropertyOrder({
  CurrentValidatorSetSubstate.JSON_PROPERTY_VALIDATOR_SET
})
...
public class CurrentValidatorSetSubstate extends Substate {
  ...
  public CurrentValidatorSetSubstate() { 
  }

  public CurrentValidatorSetSubstate validatorSet(List<ActiveValidator> validatorSet) {
    this.validatorSet = validatorSet;
    return this;
  }

  public CurrentValidatorSetSubstate addValidatorSetItem(ActiveValidator validatorSetItem) {
  ...
  **/
  ...
  /**
   * Return true if this CurrentValidatorSetSubstate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CurrentValidatorSetSubstate currentValidatorSetSubstate = (CurrentValidatorSetSubstate) o;
    return Objects.equals(this.validatorSet, currentValidatorSetSubstate.validatorSet) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrentValidatorSetSubstate {\n");
...
static {
  ...
  JSON.registerDiscriminator(CurrentValidatorSetSubstate.class, "substate_type", mappings);
}
}
