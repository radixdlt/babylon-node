...
import com.radixdlt.api.core.generated.models.MutabilityEntrySubstateAllOf;
 ...
 */
@JsonPropertyOrder({
  MutabilityEntrySubstate.JSON_PROPERTY_OBJECT_MODULE_ID,
  MutabilityEntrySubstate.JSON_PROPERTY_ROLE_KEY,
  MutabilityEntrySubstate.JSON_PROPERTY_MUTABLE_ROLE_KEYS
})
...
public class MutabilityEntrySubstate extends Substate {
  ...
  public MutabilityEntrySubstate() { 
  }

  public MutabilityEntrySubstate objectModuleId(ObjectModuleId objectModuleId) {
  ...
  **/
  ...
  public MutabilityEntrySubstate roleKey(String roleKey) {
  ...
  **/
  ...
  public MutabilityEntrySubstate mutableRoleKeys(List<String> mutableRoleKeys) {
    this.mutableRoleKeys = mutableRoleKeys;
    return this;
  }

  public MutabilityEntrySubstate addMutableRoleKeysItem(String mutableRoleKeysItem) {
  ...
  **/
  ...
  /**
   * Return true if this MutabilityEntrySubstate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MutabilityEntrySubstate mutabilityEntrySubstate = (MutabilityEntrySubstate) o;
    return Objects.equals(this.objectModuleId, mutabilityEntrySubstate.objectModuleId) &&
        Objects.equals(this.roleKey, mutabilityEntrySubstate.roleKey) &&
        Objects.equals(this.mutableRoleKeys, mutabilityEntrySubstate.mutableRoleKeys) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class MutabilityEntrySubstate {\n");
...
static {
  ...
  JSON.registerDiscriminator(MutabilityEntrySubstate.class, "substate_type", mappings);
}
}
