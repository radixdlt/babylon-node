...
import com.radixdlt.api.core.generated.models.TwoResourcePoolSubstateAllOf;
 ...
 */
@JsonPropertyOrder({
  TwoResourcePoolSubstate.JSON_PROPERTY_VAULTS,
  TwoResourcePoolSubstate.JSON_PROPERTY_POOL_UNIT_RESOURCE_ADDRESS
})
...
public class TwoResourcePoolSubstate extends Substate {
  ...
  public TwoResourcePoolSubstate() { 
  }

  public TwoResourcePoolSubstate vaults(List<PoolVault> vaults) {
    this.vaults = vaults;
    return this;
  }

  public TwoResourcePoolSubstate addVaultsItem(PoolVault vaultsItem) {
  ...
  **/
  ...
  public TwoResourcePoolSubstate poolUnitResourceAddress(String poolUnitResourceAddress) {
  ...
  **/
  ...
  /**
   * Return true if this TwoResourcePoolSubstate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TwoResourcePoolSubstate twoResourcePoolSubstate = (TwoResourcePoolSubstate) o;
    return Objects.equals(this.vaults, twoResourcePoolSubstate.vaults) &&
        Objects.equals(this.poolUnitResourceAddress, twoResourcePoolSubstate.poolUnitResourceAddress) &&
        super.equals(o);
  }
...
static {
  ...
  JSON.registerDiscriminator(TwoResourcePoolSubstate.class, "substate_type", mappings);
}
}
