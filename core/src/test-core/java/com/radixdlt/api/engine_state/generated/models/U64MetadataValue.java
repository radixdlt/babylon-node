...
import com.radixdlt.api.engine_state.generated.models.U64MetadataValueAllOf;
 ...
 */
@JsonPropertyOrder({
  U64MetadataValue.JSON_PROPERTY_VALUE
})
...
public class U64MetadataValue extends MetadataValue {
  public static final String JSON_PROPERTY_VALUE = "value";
  private String value;

  public U64MetadataValue() { 
  }

  public U64MetadataValue value(String value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "An unsigned 64-bit integer, encoded as a string (because of JSON limitations).")
  ...
  /**
   * Return true if this U64MetadataValue object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    U64MetadataValue u64MetadataValue = (U64MetadataValue) o;
    return Objects.equals(this.value, u64MetadataValue.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class U64MetadataValue {\n");
...
static {
  ...
  JSON.registerDiscriminator(U64MetadataValue.class, "type", mappings);
}
}
