...
import com.radixdlt.api.engine_state.generated.models.ObjectRoyaltyRequest;
import com.radixdlt.api.engine_state.generated.models.ObjectRoyaltyResponse;
...
public class AttachedModulesApi {
   ...
   * @param objectRoyaltyRequest  (required)
   * @return ObjectRoyaltyResponse
   * @throws ApiException if fails to make API call
   */
  public ObjectRoyaltyResponse objectAttachedModulesRoyaltyPost(ObjectRoyaltyRequest objectRoyaltyRequest) throws ApiException {
    ApiResponse<ObjectRoyaltyResponse> localVarResponse = objectAttachedModulesRoyaltyPostWithHttpInfo(objectRoyaltyRequest);
    return localVarResponse.getData();
  }
   ...
   * Reads the currently configured Package and Component Royalty amounts of particular Object&#39;s  methods. 
   * @param objectRoyaltyRequest  (required)
   * @return ApiResponse&lt;ObjectRoyaltyResponse&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ObjectRoyaltyResponse> objectAttachedModulesRoyaltyPostWithHttpInfo(ObjectRoyaltyRequest objectRoyaltyRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = objectAttachedModulesRoyaltyPostRequestBuilder(objectRoyaltyRequest);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("objectAttachedModulesRoyaltyPost", localVarResponse);
        }
        return new ApiResponse<ObjectRoyaltyResponse>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<ObjectRoyaltyResponse>() {}) // closes the InputStream
  ...
  private HttpRequest.Builder objectAttachedModulesRoyaltyPostRequestBuilder(ObjectRoyaltyRequest objectRoyaltyRequest) throws ApiException {
    // verify the required parameter 'objectRoyaltyRequest' is set
    if (objectRoyaltyRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'objectRoyaltyRequest' when calling objectAttachedModulesRoyaltyPost");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/object/attached-modules/royalty";
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(objectRoyaltyRequest);
      localVarRequestBuilder.method("POST", HttpRequest.BodyPublishers.ofByteArray(localVarPostBody));
    } catch (IOException e) {
      throw new ApiException(e);
    }
