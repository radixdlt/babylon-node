...
public class ObjectMetadataEntryRequest {
  ...
  public ObjectMetadataEntryRequest entityAddress(String entityAddress) {
  ...
  **/
  ...
  public ObjectMetadataEntryRequest key(String key) {
    this.key = key;
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The metadata key (i.e. always a string) to look up the entry by.")
  ...
  public ObjectMetadataEntryRequest sborFormatOptions(SborFormatOptions sborFormatOptions) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ObjectMetadataEntryRequest {\n");
