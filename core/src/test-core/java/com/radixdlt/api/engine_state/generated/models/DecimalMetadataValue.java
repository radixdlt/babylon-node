...
import com.radixdlt.api.engine_state.generated.models.DecimalMetadataValueAllOf;
 ...
 */
@JsonPropertyOrder({
  DecimalMetadataValue.JSON_PROPERTY_VALUE
})
...
public class DecimalMetadataValue extends MetadataValue {
  public static final String JSON_PROPERTY_VALUE = "value";
  private String value;

  public DecimalMetadataValue() { 
  }

  public DecimalMetadataValue value(String value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "A string-encoded fixed-precision decimal to 18 decimal places.")
  ...
  /**
   * Return true if this DecimalMetadataValue object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DecimalMetadataValue decimalMetadataValue = (DecimalMetadataValue) o;
    return Objects.equals(this.value, decimalMetadataValue.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class DecimalMetadataValue {\n");
...
static {
  ...
  JSON.registerDiscriminator(DecimalMetadataValue.class, "type", mappings);
}
}
