...
import com.radixdlt.api.engine_state.generated.models.NonFungibleGlobalIdMetadataValueAllOf;
 ...
 */
@JsonPropertyOrder({
  NonFungibleGlobalIdMetadataValue.JSON_PROPERTY_VALUE
})
...
public class NonFungibleGlobalIdMetadataValue extends MetadataValue {
  public static final String JSON_PROPERTY_VALUE = "value";
  private NonFungibleGlobalId value;

  public NonFungibleGlobalIdMetadataValue() { 
  }

  public NonFungibleGlobalIdMetadataValue value(NonFungibleGlobalId value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public NonFungibleGlobalId getValue() {
    return value;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VALUE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setValue(NonFungibleGlobalId value) {
    this.value = value;
  }


  /**
   * Return true if this NonFungibleGlobalIdMetadataValue object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    NonFungibleGlobalIdMetadataValue nonFungibleGlobalIdMetadataValue = (NonFungibleGlobalIdMetadataValue) o;
    return Objects.equals(this.value, nonFungibleGlobalIdMetadataValue.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class NonFungibleGlobalIdMetadataValue {\n");
...
static {
  ...
  JSON.registerDiscriminator(NonFungibleGlobalIdMetadataValue.class, "type", mappings);
}
}
