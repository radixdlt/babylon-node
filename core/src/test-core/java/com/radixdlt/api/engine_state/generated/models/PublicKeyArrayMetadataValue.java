...
import com.radixdlt.api.engine_state.generated.models.PublicKeyArrayMetadataValueAllOf;
 ...
 */
@JsonPropertyOrder({
  PublicKeyArrayMetadataValue.JSON_PROPERTY_VALUE
})
...
public class PublicKeyArrayMetadataValue extends MetadataValue {
  public static final String JSON_PROPERTY_VALUE = "value";
  private List<PublicKey> value = new ArrayList<>();

  public PublicKeyArrayMetadataValue() { 
  }

  public PublicKeyArrayMetadataValue value(List<PublicKey> value) {
    this.value = value;
    return this;
  }

  public PublicKeyArrayMetadataValue addValueItem(PublicKey valueItem) {
  ...
  **/
  ...
  public List<PublicKey> getValue() {
    return value;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VALUE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setValue(List<PublicKey> value) {
    this.value = value;
  }


  /**
   * Return true if this PublicKeyArrayMetadataValue object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PublicKeyArrayMetadataValue publicKeyArrayMetadataValue = (PublicKeyArrayMetadataValue) o;
    return Objects.equals(this.value, publicKeyArrayMetadataValue.value) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class PublicKeyArrayMetadataValue {\n");
...
static {
  ...
  JSON.registerDiscriminator(PublicKeyArrayMetadataValue.class, "type", mappings);
}
}
