...
public class SignedTransactionIntent {
  ...
  private List<IntentSignature> intentSignatures = new ArrayList<>();
  ...
  **/
  ...
  public SignedTransactionIntent intentSignatures(List<IntentSignature> intentSignatures) {
    this.intentSignatures = intentSignatures;
    return this;
  }

  public SignedTransactionIntent addIntentSignaturesItem(IntentSignature intentSignaturesItem) {
  ...
  **/
  ...
  public List<IntentSignature> getIntentSignatures() {
    return intentSignatures;
  }
  ...
  @JsonProperty(JSON_PROPERTY_INTENT_SIGNATURES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIntentSignatures(List<IntentSignature> intentSignatures) {
    this.intentSignatures = intentSignatures;
  }
