...
public class PrometheusApiModule extends PrivateModule {
  ...
  public PrometheusApiModule(String bindAddress, int port) {
  ...
  protected void configure() {
    ...
    var binder =
        MapBinder.newMapBinder(
            binder(), HandlerRoute.class, HttpHandler.class, PrometheusApiEndpoints.class);
    binder.addBinding(HandlerRoute.get("/prometheus/metrics")).to(PrometheusHandler.class);
  }
