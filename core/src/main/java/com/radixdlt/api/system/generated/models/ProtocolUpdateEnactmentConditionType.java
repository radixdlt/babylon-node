...
/**
 * Gets or Sets ProtocolUpdateEnactmentConditionType
 */
public enum ProtocolUpdateEnactmentConditionType {
  ...
  ProtocolUpdateEnactmentConditionType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ProtocolUpdateEnactmentConditionType fromValue(String value) {
    for (ProtocolUpdateEnactmentConditionType b : ProtocolUpdateEnactmentConditionType.values()) {
