...
/**
 * Gets or Sets ProtocolUpdateSupportTypeDiscriminator
 */
public enum ProtocolUpdateSupportTypeDiscriminator {
  
  SIGNALLEDREADINESS("SignalledReadiness");

  private String value;

  ProtocolUpdateSupportTypeDiscriminator(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ProtocolUpdateSupportTypeDiscriminator fromValue(String value) {
    for (ProtocolUpdateSupportTypeDiscriminator b : ProtocolUpdateSupportTypeDiscriminator.values()) {
