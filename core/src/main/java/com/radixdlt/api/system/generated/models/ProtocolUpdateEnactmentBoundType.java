...
/**
 * Gets or Sets ProtocolUpdateEnactmentBoundType
 */
public enum ProtocolUpdateEnactmentBoundType {
  ...
  ProtocolUpdateEnactmentBoundType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ProtocolUpdateEnactmentBoundType fromValue(String value) {
    for (ProtocolUpdateEnactmentBoundType b : ProtocolUpdateEnactmentBoundType.values()) {
