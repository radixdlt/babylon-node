...
public final class REv2TransactionsAndProofReader implements TransactionsAndProofReader {
  ...
  private static final int MAX_TXNS_FOR_RESPONSES_SPANNING_MORE_THAN_ONE_PROOF = 10;
  ...
  public static final int MAX_TXN_BYTES_FOR_A_SINGLE_RESPONSE = 2 * 1024 * 1024; // 2 MiB
