...
public class SborCoderTest {
  ...
  public void unitCanBeEncodedAndDecoded() {
    ...
    var r0 = SborCoder.DEFAULT.encode(Unit.unit(), Unit.class);

    assertEquals(1, r0.length);
    assertEquals(0, r0[0]); // Type == 0x00 - Unit

    var r1 = SborCoder.DEFAULT.decode(r0, Unit.class);
  ...
  public void booleanCanBeEncodedAndDecoded() {
    var r0 = SborCoder.DEFAULT.encode(true, boolean.class);

    assertEquals(2, r0.length);
    assertEquals(1, r0[0]); // Type == 0x01 - Boolean
    assertEquals(1, r0[1]); // Value = 1 == true

    var r1 = SborCoder.DEFAULT.decode(r0, boolean.class);
  ...
  public void byteCanBeEncodedAndDecoded() {
    var r0 = SborCoder.DEFAULT.encode((byte) 0x5A, byte.class);

    assertEquals(2, r0.length);
    assertEquals(7, r0[0]); // Type == 0x07 - u8
    assertEquals(0x5A, r0[1]); // Value == 0x5A

    var r1 = SborCoder.DEFAULT.decode(r0, byte.class);
  ...
  public void shortCanBeEncodedAndDecoded() {
    var r0 = SborCoder.DEFAULT.encode((short) 0x1234, short.class);
    ...
    var r1 = SborCoder.DEFAULT.decode(r0, short.class);
  ...
  public void intCanBeEncodedAndDecoded() {
    var r0 = SborCoder.DEFAULT.encode(0x12345678, int.class);
    ...
    var r1 = SborCoder.DEFAULT.decode(r0, int.class);
  ...
  public void longCanBeEncodedAndDecoded() {
    var r0 = SborCoder.DEFAULT.encode(0x0123_4567_89AB_CDEFL, long.class);
    ...
    var r1 = SborCoder.DEFAULT.decode(r0, long.class);
  ...
  public void stringCanBeEncodedAndDecoded() {
    var r0 = SborCoder.DEFAULT.encode("Test string", String.class);
    ...
    var r1 = SborCoder.DEFAULT.decode(r0, String.class);
  ...
  public void byteArrayCanBeEncodedAndDecoded() {
    ...
    var r0 = SborCoder.DEFAULT.encode(testVector, byte[].class);
  ...
  public void shortArrayCanBeEncodedAndDecoded() {
    ...
    var r0 = SborCoder.DEFAULT.encode(testVector, short[].class);
  ...
  public void intArrayCanBeEncodedAndDecoded() {
    ...
    var r0 = SborCoder.DEFAULT.encode(testVector, int[].class);
  ...
  public void longArrayCanBeEncodedAndDecoded() {
    ...
    var r0 = SborCoder.DEFAULT.encode(testVector);
  ...
  public void someOptionCanBeEncodedAndDecoded() {
    ...
    var r0 = SborCoder.DEFAULT.encode(some("Test value"), optionTypeLiteral);
    ...
    var r1 = SborCoder.DEFAULT.decode(r0, optionTypeLiteral);
  ...
  public void noneOptionCanBeEncodedAndDecoded() {
    var optionTypeLiteral = new TypeToken<Option<String>>() {};
    var r0 = SborCoder.DEFAULT.encode(none(), optionTypeLiteral);
  ...
  public void eitherCanBeEncodedAndDecoded() {
    ...
    var leftEncoded = SborCoder.DEFAULT.encode(leftValue, eitherTypeLiteral);
    ...
    var rightEncoded = SborCoder.DEFAULT.encode(rightValue, eitherTypeLiteral);
    ...
    var leftOut = SborCoder.DEFAULT.decode(leftEncoded, eitherTypeLiteral);
    var rightOut = SborCoder.DEFAULT.decode(rightEncoded, eitherTypeLiteral);
  ...
  public void objectTreeCanBeEncodedAndDecoded() {
    ...
    var r0 = SborCoder.DEFAULT.encode(testValue, SimpleRecord.class);
    ...
    var r1 = SborCoder.DEFAULT.decode(r0, SimpleRecord.class);
