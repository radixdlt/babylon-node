 ...
 */
public record RawPreviewTransaction(byte[] payload) {
  public RawPreviewTransaction {
    Objects.requireNonNull(payload);
  }

  public static void registerCodec(CodecMap codecMap) {
    codecMap.register(
        RawPreviewTransaction.class,
        codecs ->
            StructCodec.transparent(
                RawPreviewTransaction::new, codecs.of(byte[].class), t -> t.payload));
  }

  @JsonCreator
  public static RawPreviewTransaction create(byte[] payload) {
    return new RawPreviewTransaction(payload);
  }
  ...
  public boolean equals(Object o) {
    if (!(o instanceof RawPreviewTransaction other)) {
      return false;
    }
