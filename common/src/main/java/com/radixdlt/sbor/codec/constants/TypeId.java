...
public enum TypeId {
  ...
  TYPE_CUSTOM_ECDSA_SECP256K1_PUBLIC_KEY(0x91),
  TYPE_CUSTOM_ECDSA_SECP256K1_SIGNATURE(0x92),
  TYPE_CUSTOM_EDDSA_ED25519_PUBLIC_KEY(0x93),
  TYPE_CUSTOM_EDDSA_ED25519_SIGNATURE(0x94),
  TYPE_CUSTOM_DECIMAL(0xA1),
  TYPE_CUSTOM_RESOURCE_ADDRESS(0xB6);
