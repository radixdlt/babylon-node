...
import static com.radixdlt.sbor.codec.constants.TypeId.TYPE_U32;
...
public final class IntegerCodec implements Codec<Integer> {
  ...
  /**
   * Note that ints are always signed in Java. If signed is false, you may have a positive SBOR
