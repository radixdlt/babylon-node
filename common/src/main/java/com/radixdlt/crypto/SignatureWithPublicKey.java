...
public sealed interface SignatureWithPublicKey {
  static void registerCodec(CodecMap codecMap) {
    codecMap.register(
        SignatureWithPublicKey.class,
        codecs -> EnumCodec.fromPermittedRecordSubclasses(SignatureWithPublicKey.class, codecs));
  }
