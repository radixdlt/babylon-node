 ...
 * 
 * @export
 * @interface ParsedNotarizedTransactionAllOfIdentifiers
 */
export interface ParsedNotarizedTransactionAllOfIdentifiers {
    /**
...
/**
 * Check if a given object implements the ParsedNotarizedTransactionAllOfIdentifiers interface.
 */
...
export function ParsedNotarizedTransactionAllOfIdentifiersFromJSON(json: any): ParsedNotarizedTransactionAllOfIdentifiers {
    return ParsedNotarizedTransactionAllOfIdentifiersFromJSONTyped(json, false);
}

export function ParsedNotarizedTransactionAllOfIdentifiersFromJSONTyped(json: any, ignoreDiscriminator: boolean): ParsedNotarizedTransactionAllOfIdentifiers {
...
export function ParsedNotarizedTransactionAllOfIdentifiersToJSON(value?: ParsedNotarizedTransactionAllOfIdentifiers | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
