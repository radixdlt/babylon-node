 ...
 * 
 * @export
 * @interface StaticRolesAuthTemplate
 */
export interface StaticRolesAuthTemplate {
    /**
     * 
     * @type {RoleSpecification}
     * @memberof StaticRolesAuthTemplate
     */
...
/**
 * Check if a given object implements the StaticRolesAuthTemplate interface.
 */
export function instanceOfStaticRolesAuthTemplate(value: object): boolean {
    let isInstance = true;
...
export function StaticRolesAuthTemplateFromJSON(json: any): StaticRolesAuthTemplate {
    return StaticRolesAuthTemplateFromJSONTyped(json, false);
}

export function StaticRolesAuthTemplateFromJSONTyped(json: any, ignoreDiscriminator: boolean): StaticRolesAuthTemplate {
...
export function StaticRolesAuthTemplateToJSON(value?: StaticRolesAuthTemplate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
