 ...
 * 
 * @export
 * @interface StateComponentDescendentId
 */
...
/**
 * Check if a given object implements the StateComponentDescendentId interface.
 */
...
export function StateComponentDescendentIdFromJSON(json: any): StateComponentDescendentId {
    return StateComponentDescendentIdFromJSONTyped(json, false);
}

export function StateComponentDescendentIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): StateComponentDescendentId {
...
export function StateComponentDescendentIdToJSON(value?: StateComponentDescendentId | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
