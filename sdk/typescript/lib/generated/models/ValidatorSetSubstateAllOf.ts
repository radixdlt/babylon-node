 ...
 * 
 * @export
 * @interface ValidatorSetSubstateAllOf
 */
 ...
 * @export
 */
export const ValidatorSetSubstateAllOfSubstateTypeEnum = {
    ValidatorSet: 'ValidatorSet'
} as const;
export type ValidatorSetSubstateAllOfSubstateTypeEnum = typeof ValidatorSetSubstateAllOfSubstateTypeEnum[keyof typeof ValidatorSetSubstateAllOfSubstateTypeEnum];


/**
 * Check if a given object implements the ValidatorSetSubstateAllOf interface.
 */
...
export function ValidatorSetSubstateAllOfFromJSON(json: any): ValidatorSetSubstateAllOf {
    return ValidatorSetSubstateAllOfFromJSONTyped(json, false);
}

export function ValidatorSetSubstateAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValidatorSetSubstateAllOf {
...
export function ValidatorSetSubstateAllOfToJSON(value?: ValidatorSetSubstateAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
