...
/**
 * Check if a given object implements the TransactionManifest interface.
 */
...
export function TransactionManifestFromJSON(json: any): TransactionManifest {
    return TransactionManifestFromJSONTyped(json, false);
}

export function TransactionManifestFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionManifest {
...
export function TransactionManifestToJSON(value?: TransactionManifest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
