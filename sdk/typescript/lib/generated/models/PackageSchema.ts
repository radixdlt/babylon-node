...
import type { BlueprintSchema } from './BlueprintSchema';
import {
    BlueprintSchemaFromJSON,
    BlueprintSchemaFromJSONTyped,
    BlueprintSchemaToJSON,
...
export interface PackageSchema {
     ...
     * @type {{ [key: string]: BlueprintSchema; }}
     * @memberof PackageSchema
     */
    blueprint_schemas: { [key: string]: BlueprintSchema; };
}
...
export function instanceOfPackageSchema(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "blueprint_schemas" in value;
...
export function PackageSchemaFromJSONTyped(json: any, ignoreDiscriminator: boolean): PackageSchema {
    ...
    return {
        ...
        'blueprint_schemas': (mapValues(json['blueprint_schemas'], BlueprintSchemaFromJSON)),
    };
}
...
export function PackageSchemaToJSON(value?: PackageSchema | null): any {
    ...
    return {
        ...
        'blueprint_schemas': (mapValues(value.blueprint_schemas, BlueprintSchemaToJSON)),
    };
}
