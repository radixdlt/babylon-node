...
import {
    ...
    instanceOfSystemLedgerTransaction,
    SystemLedgerTransactionFromJSON,
    SystemLedgerTransactionFromJSONTyped,
    SystemLedgerTransactionToJSON,
} from './SystemLedgerTransaction';
import {
...
import {
    ...
    instanceOfValidatorLedgerTransaction,
    ValidatorLedgerTransactionFromJSON,
    ValidatorLedgerTransactionFromJSONTyped,
    ValidatorLedgerTransactionToJSON,
} from './ValidatorLedgerTransaction';
 ...
 * @export
 */
export type LedgerTransaction = { type: 'System' } & SystemLedgerTransaction | { type: 'User' } & UserLedgerTransaction | { type: 'Validator' } & ValidatorLedgerTransaction;
...
export function LedgerTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): LedgerTransaction {
    ...
    switch (json['type']) {
        case 'System':
            return {...SystemLedgerTransactionFromJSONTyped(json, true), type: 'System'};
        case 'User':
            return {...UserLedgerTransactionFromJSONTyped(json, true), type: 'User'};
        case 'Validator':
            return {...ValidatorLedgerTransactionFromJSONTyped(json, true), type: 'Validator'};
        default:
...
export function LedgerTransactionToJSON(value?: LedgerTransaction | null): any {
    ...
    switch (value['type']) {
        case 'System':
            return SystemLedgerTransactionToJSON(value);
        case 'User':
            return UserLedgerTransactionToJSON(value);
        case 'Validator':
            return ValidatorLedgerTransactionToJSON(value);
        default:
