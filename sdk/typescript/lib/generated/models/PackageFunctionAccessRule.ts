 ...
 * 
 * @export
 * @interface PackageFunctionAccessRule
 */
...
/**
 * Check if a given object implements the PackageFunctionAccessRule interface.
 */
...
export function PackageFunctionAccessRuleFromJSON(json: any): PackageFunctionAccessRule {
    return PackageFunctionAccessRuleFromJSONTyped(json, false);
}

export function PackageFunctionAccessRuleFromJSONTyped(json: any, ignoreDiscriminator: boolean): PackageFunctionAccessRule {
...
export function PackageFunctionAccessRuleToJSON(value?: PackageFunctionAccessRule | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
