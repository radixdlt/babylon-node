...
/**
 * Check if a given object implements the GroupedAuthEntry interface.
 */
...
export function GroupedAuthEntryFromJSON(json: any): GroupedAuthEntry {
    return GroupedAuthEntryFromJSONTyped(json, false);
}

export function GroupedAuthEntryFromJSONTyped(json: any, ignoreDiscriminator: boolean): GroupedAuthEntry {
...
export function GroupedAuthEntryToJSON(value?: GroupedAuthEntry | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
