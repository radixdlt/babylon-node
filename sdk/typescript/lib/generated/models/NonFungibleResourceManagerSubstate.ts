 ...
 * 
 * @export
 * @interface NonFungibleResourceManagerSubstate
 */
export interface NonFungibleResourceManagerSubstate {
    /**
     * 
     * @type {string}
 ...
 * @export
 */
export const NonFungibleResourceManagerSubstateSubstateTypeEnum = {
    NonFungibleResourceManager: 'NonFungibleResourceManager'
} as const;
export type NonFungibleResourceManagerSubstateSubstateTypeEnum = typeof NonFungibleResourceManagerSubstateSubstateTypeEnum[keyof typeof NonFungibleResourceManagerSubstateSubstateTypeEnum];


/**
 * Check if a given object implements the NonFungibleResourceManagerSubstate interface.
 */
...
export function NonFungibleResourceManagerSubstateFromJSON(json: any): NonFungibleResourceManagerSubstate {
    return NonFungibleResourceManagerSubstateFromJSONTyped(json, false);
}

export function NonFungibleResourceManagerSubstateFromJSONTyped(json: any, ignoreDiscriminator: boolean): NonFungibleResourceManagerSubstate {
...
export function NonFungibleResourceManagerSubstateToJSON(value?: NonFungibleResourceManagerSubstate | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
