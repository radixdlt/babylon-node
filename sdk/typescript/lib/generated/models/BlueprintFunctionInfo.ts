...
import type { BlueprintFunctionReceiverInfo } from './BlueprintFunctionReceiverInfo';
import {
    BlueprintFunctionReceiverInfoFromJSON,
    BlueprintFunctionReceiverInfoFromJSONTyped,
    BlueprintFunctionReceiverInfoToJSON,
} from './BlueprintFunctionReceiverInfo';
...
export interface BlueprintFunctionInfo {
    ...
    /**
     * 
     * @type {BlueprintFunctionReceiverInfo}
     * @memberof BlueprintFunctionInfo
     */
    receiver?: BlueprintFunctionReceiverInfo;
    /**
     * 
...
export function BlueprintFunctionInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlueprintFunctionInfo {
    ...
    return {
        ...
        'name': json['name'],
        'receiver': !exists(json, 'receiver') ? undefined : BlueprintFunctionReceiverInfoFromJSON(json['receiver']),
...
export function BlueprintFunctionInfoToJSON(value?: BlueprintFunctionInfo | null): any {
    ...
    return {
        ...
        'name': value.name,
        'receiver': BlueprintFunctionReceiverInfoToJSON(value.receiver),
