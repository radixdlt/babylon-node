 ...
 * 
 * @export
 * @interface DeletedSubstateVersionRef
 */
...
/**
 * Check if a given object implements the DeletedSubstateVersionRef interface.
 */
...
export function DeletedSubstateVersionRefFromJSON(json: any): DeletedSubstateVersionRef {
    return DeletedSubstateVersionRefFromJSONTyped(json, false);
}

export function DeletedSubstateVersionRefFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeletedSubstateVersionRef {
...
export function DeletedSubstateVersionRefToJSON(value?: DeletedSubstateVersionRef | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
