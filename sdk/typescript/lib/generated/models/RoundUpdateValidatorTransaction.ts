 ...
 * 
 * @export
 * @interface RoundUpdateValidatorTransaction
 */
export interface RoundUpdateValidatorTransaction {
    /**
     * 
     * @type {string}
 ...
 * @export
 */
export const RoundUpdateValidatorTransactionTypeEnum = {
    RoundUpdate: 'RoundUpdate'
} as const;
export type RoundUpdateValidatorTransactionTypeEnum = typeof RoundUpdateValidatorTransactionTypeEnum[keyof typeof RoundUpdateValidatorTransactionTypeEnum];


/**
 * Check if a given object implements the RoundUpdateValidatorTransaction interface.
 */
...
export function RoundUpdateValidatorTransactionFromJSON(json: any): RoundUpdateValidatorTransaction {
    return RoundUpdateValidatorTransactionFromJSONTyped(json, false);
}

export function RoundUpdateValidatorTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): RoundUpdateValidatorTransaction {
...
export function RoundUpdateValidatorTransactionToJSON(value?: RoundUpdateValidatorTransaction | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
