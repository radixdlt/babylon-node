...
/**
 * Check if a given object implements the BlueprintReference interface.
 */
export function instanceOfBlueprintReference(value: object): boolean {
    let isInstance = true;
...
export function BlueprintReferenceFromJSON(json: any): BlueprintReference {
    return BlueprintReferenceFromJSONTyped(json, false);
}

export function BlueprintReferenceFromJSONTyped(json: any, ignoreDiscriminator: boolean): BlueprintReference {
...
export function BlueprintReferenceToJSON(value?: BlueprintReference | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
