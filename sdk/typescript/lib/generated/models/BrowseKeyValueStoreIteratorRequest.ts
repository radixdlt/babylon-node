 ...
 * 
 * @export
 * @interface BrowseKeyValueStoreIteratorRequest
 */
export interface BrowseKeyValueStoreIteratorRequest {
    /**
     * The logical name of the network
     * @type {string}
     * @memberof BrowseKeyValueStoreIteratorRequest
     */
    network: string;
    /**
...
/**
 * Check if a given object implements the BrowseKeyValueStoreIteratorRequest interface.
 */
export function instanceOfBrowseKeyValueStoreIteratorRequest(value: object): boolean {
    let isInstance = true;
...
export function BrowseKeyValueStoreIteratorRequestFromJSON(json: any): BrowseKeyValueStoreIteratorRequest {
    return BrowseKeyValueStoreIteratorRequestFromJSONTyped(json, false);
}

export function BrowseKeyValueStoreIteratorRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): BrowseKeyValueStoreIteratorRequest {
...
export function BrowseKeyValueStoreIteratorRequestToJSON(value?: BrowseKeyValueStoreIteratorRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
