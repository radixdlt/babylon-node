...
extern "system" fn Java_com_radixdlt_p2p_RocksDbAddressBookStore_removeOne(
    ...
    jni_sbor_coded_call(&env, node_id, |request: NodeIdDTO| -> bool {
        JNINodeRustEnvironment::get_address_book_database(&env, j_rust_global_context)
            .remove_one(&request.key)
    })
}

#[no_mangle]
extern "system" fn Java_com_radixdlt_p2p_RocksDbAddressBookStore_upsertOne(
    env: JNIEnv,
    _class: JClass,
    j_rust_global_context: JObject,
    ...
    jni_sbor_coded_call(&env, address_entry, |request: AddressBookEntry| -> bool {
        JNINodeRustEnvironment::get_address_book_database(&env, j_rust_global_context)
            .upsert_one(&request.node_id.key, &request)
    })
}

#[no_mangle]
extern "system" fn Java_com_radixdlt_p2p_RocksDbAddressBookStore_reset(
    env: JNIEnv,
    _class: JClass,
    j_rust_global_context: JObject,
    node_id: jbyteArray,
...
#[no_mangle]
extern "system" fn Java_com_radixdlt_p2p_RocksDbAddressBookStore_getAll(
    env: JNIEnv,
    _class: JClass,
    j_rust_global_context: JObject,
    node_id: jbyteArray,
) -> jbyteArray {
    jni_sbor_coded_call(&env, node_id, |_: ()| -> Vec<AddressBookEntry> {
        JNINodeRustEnvironment::get_address_book_database(&env, j_rust_global_context).get_all()
    })
}

#[no_mangle]
extern "system" fn Java_com_radixdlt_p2p_RocksDbAddressBookStore_markAsMigrated(
    env: JNIEnv,
    _class: JClass,
    j_rust_global_context: JObject,
    node_id: jbyteArray,
...
#[no_mangle]
extern "system" fn Java_com_radixdlt_p2p_RocksDbAddressBookStore_isMigrated(
    env: JNIEnv,
    _class: JClass,
    j_rust_global_context: JObject,
    node_id: jbyteArray,
