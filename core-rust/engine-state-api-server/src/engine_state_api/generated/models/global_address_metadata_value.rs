...
pub struct GlobalAddressMetadataValue {
    #[serde(rename = "type")]
...
impl GlobalAddressMetadataValue {
    pub fn new(_type: crate::engine_state_api::generated::models::MetadataValueType, value: String) -> GlobalAddressMetadataValue {
