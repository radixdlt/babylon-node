...
pub struct StateVersionInFutureDetails {
...
impl StateVersionInFutureDetails {
    pub fn new(error_type: crate::engine_state_api::generated::models::ErrorType, current_state_version: i64) -> StateVersionInFutureDetails {
