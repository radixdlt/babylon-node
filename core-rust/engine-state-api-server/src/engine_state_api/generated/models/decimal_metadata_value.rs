...
pub struct DecimalMetadataValue {
    #[serde(rename = "type")]
...
impl DecimalMetadataValue {
    pub fn new(_type: crate::engine_state_api::generated::models::MetadataValueType, value: String) -> DecimalMetadataValue {
