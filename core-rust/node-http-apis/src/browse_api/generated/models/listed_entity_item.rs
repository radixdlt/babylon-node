...
pub struct ListedEntityItem {
    ...
    pub blueprint: Option<Box<crate::browse_api::generated::models::UnversionedBlueprintReference>>,
}

impl ListedEntityItem {
    pub fn new(entity_address: String, system_type: crate::browse_api::generated::models::SystemType, entity_type: crate::browse_api::generated::models::EntityType, is_global: bool, created_at_state_version: i64) -> ListedEntityItem {
        ListedEntityItem {
            entity_address,
            system_type,
            entity_type,
