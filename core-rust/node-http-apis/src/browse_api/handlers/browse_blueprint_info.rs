...
pub(crate) async fn handle_browse_blueprint_info(
    state: State<BrowseApiState>,
    Json(request): Json<models::BrowseBlueprintInfoRequest>,
) -> Result<Json<models::BrowseBlueprintInfoResponse>, ResponseError> {
    ...
    Ok(models::BrowseBlueprintInfoResponse {
