...
pub struct BlueprintFieldInfo {
    ...
    pub type_reference: Option<crate::core_api::generated::models::BlueprintResolvedTypeReference>, // Using Option permits Default trait; Will always be Some in normal use
    #[serde(rename = "condition", skip_serializing_if = "Option::is_none")]
    pub condition: Option<Box<crate::core_api::generated::models::BlueprintFieldCondition>>,
    #[serde(rename = "transience", skip_serializing_if = "Option::is_none")]
    pub transience: Option<Box<crate::core_api::generated::models::BlueprintFieldTransience>>,
}

impl BlueprintFieldInfo {
    pub fn new(index: i32, type_reference: crate::core_api::generated::models::BlueprintResolvedTypeReference) -> BlueprintFieldInfo {
        BlueprintFieldInfo {
            index,
            name: None,
