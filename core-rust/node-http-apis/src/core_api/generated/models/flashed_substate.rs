...
impl FlashedSubstate {
    pub fn new(entity_address: String, partition_number: i32, substate_key: crate::core_api::generated::models::SubstateKey, value: String) -> FlashedSubstate {
        FlashedSubstate {
            entity_address,
            partition_number,
