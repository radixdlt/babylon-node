...
pub struct BrowseObjectCollectionIteratorRequest {
...
impl BrowseObjectCollectionIteratorRequest {
    pub fn new(network: String, entity_address: String) -> BrowseObjectCollectionIteratorRequest {
