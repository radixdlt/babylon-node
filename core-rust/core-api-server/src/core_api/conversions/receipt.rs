        ...
        SubstateSystemStructure::SystemField(SystemFieldStructure { field_kind }) => {
            models::SubstateSystemStructure::SystemFieldStructure {
                field_kind: match field_kind {
                    ...
                    SystemFieldKind::TransactionValidationConfiguration => models::SystemFieldKind::TransactionValidationConfiguration,
                    SystemFieldKind::ProtocolUpdateStatusSummary => models::SystemFieldKind::ProtocolUpdateStatusSummary,
                },
            }
        }
