...
pub struct BrowseKeyValueStoreIteratorRequest {
...
impl BrowseKeyValueStoreIteratorRequest {
    pub fn new(network: String, entity_address: String) -> BrowseKeyValueStoreIteratorRequest {
