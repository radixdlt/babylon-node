...
impl OwnerRoleSubstate {
    pub fn new(substate_type: crate::core_api::generated::models::SubstateType, owner_role: crate::core_api::generated::models::OwnerRole) -> OwnerRoleSubstate {
        OwnerRoleSubstate {
            substate_type,
