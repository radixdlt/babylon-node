...
pub struct MetadataValueSubstate {
...
impl MetadataValueSubstate {
    pub fn new(substate_type: crate::core_api::generated::models::SubstateType, key_hex: String, is_deleted: bool) -> MetadataValueSubstate {
