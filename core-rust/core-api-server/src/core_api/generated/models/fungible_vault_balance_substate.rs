...
pub struct FungibleVaultBalanceSubstate {
...
impl FungibleVaultBalanceSubstate {
    pub fn new(substate_type: crate::core_api::generated::models::SubstateType, amount: String) -> FungibleVaultBalanceSubstate {
