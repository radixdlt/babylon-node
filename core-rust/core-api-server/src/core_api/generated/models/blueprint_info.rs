...
impl BlueprintInfo {
    pub fn new(package_address: String, blueprint_name: String, features: Vec<String>, generic_substitutions: Vec<crate::core_api::generated::models::TypeIdentifier>) -> BlueprintInfo {
        BlueprintInfo {
            package_address,
            blueprint_name,
            outer_object: None,
