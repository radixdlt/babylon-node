...
pub struct TransactionPreviewRequestOptIns {
    ...
    #[serde(rename = "request_radix_engine_toolkit_receipt", skip_serializing_if = "Option::is_none")]
    pub request_radix_engine_toolkit_receipt: Option<bool>,
}

impl TransactionPreviewRequestOptIns {
    pub fn new() -> TransactionPreviewRequestOptIns {
        TransactionPreviewRequestOptIns {
            request_radix_engine_toolkit_receipt: None,
        }
    }
}
