...
pub struct PackageFieldRoyaltySubstateAllOf {
...
impl PackageFieldRoyaltySubstateAllOf {
    pub fn new(blueprint_royalties: Vec<crate::core_api::generated::models::BlueprintRoyaltyConfig>) -> PackageFieldRoyaltySubstateAllOf {
