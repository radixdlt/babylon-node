...
pub struct PackageRoyaltySubstateAllOf {
...
impl PackageRoyaltySubstateAllOf {
    pub fn new(blueprint_royalties: Vec<crate::core_api::generated::models::BlueprintRoyaltyConfig>) -> PackageRoyaltySubstateAllOf {
