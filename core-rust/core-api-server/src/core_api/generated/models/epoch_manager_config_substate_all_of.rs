...
pub struct EpochManagerConfigSubstateAllOf {
...
impl EpochManagerConfigSubstateAllOf {
    pub fn new(max_validators: i64, rounds_per_epoch: i64, num_unstake_epochs: i64) -> EpochManagerConfigSubstateAllOf {
