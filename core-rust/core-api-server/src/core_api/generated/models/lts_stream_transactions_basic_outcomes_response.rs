...
pub struct LtsStreamTransactionsBasicOutcomesResponse {
...
impl LtsStreamTransactionsBasicOutcomesResponse {
    pub fn new(from_state_version: i64, count: i32, max_ledger_state_version: i64, committed_transaction_outcomes: Vec<crate::core_api::generated::models::LtsCommittedTransactionOutcome>) -> LtsStreamTransactionsBasicOutcomesResponse {
