...
pub struct RuleAccessRuleReferenceAllOf {
...
impl RuleAccessRuleReferenceAllOf {
    pub fn new(access_rule: crate::core_api::generated::models::AccessRule) -> RuleAccessRuleReferenceAllOf {
