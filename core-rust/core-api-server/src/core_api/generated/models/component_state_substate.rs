...
impl ComponentStateSubstate {
    pub fn new(entity_type: crate::core_api::generated::models::EntityType, substate_type: crate::core_api::generated::models::SubstateType, state: String) -> ComponentStateSubstate {
