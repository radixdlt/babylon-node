...
impl EpochManagerConfigSubstate {
    pub fn new(substate_type: crate::core_api::generated::models::SubstateType, max_validators: i64, rounds_per_epoch: i64, num_unstake_epochs: i64) -> EpochManagerConfigSubstate {
