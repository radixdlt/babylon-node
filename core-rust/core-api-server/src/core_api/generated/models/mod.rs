...
pub mod transaction_submit_priority_threshold_not_met_error_details_all_of;
pub use self::transaction_submit_priority_threshold_not_met_error_details_all_of::TransactionSubmitPriorityThresholdNotMetErrorDetailsAllOf;
