...
impl PackageCodeSubstate {
    pub fn new(substate_type: crate::core_api::generated::models::SubstateType, vm_type: crate::core_api::generated::models::VmType, code_hex: String) -> PackageCodeSubstate {
        PackageCodeSubstate {
            substate_type,
            vm_type,
            code_hex,
