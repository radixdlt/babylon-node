...
pub struct RcStreamEntityTransactionsBasicOutcomesResponse {
    ...
    pub basic_outcomes: Vec<crate::core_api::generated::models::CommittedTransaction>,
}

impl RcStreamEntityTransactionsBasicOutcomesResponse {
    pub fn new(from_state_version: i64, count: i32, max_ledger_state_version: i64, basic_outcomes: Vec<crate::core_api::generated::models::CommittedTransaction>) -> RcStreamEntityTransactionsBasicOutcomesResponse {
