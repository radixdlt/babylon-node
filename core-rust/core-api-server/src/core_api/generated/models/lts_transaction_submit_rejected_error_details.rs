...
impl LtsTransactionSubmitRejectedErrorDetails {
    pub fn new(_type: crate::core_api::generated::models::LtsTransactionSubmitErrorDetailsType, error_message: String, is_fresh: bool, is_payload_rejection_permanent: bool, is_intent_rejection_permanent: bool, is_rejected_because_intent_already_committed: bool) -> LtsTransactionSubmitRejectedErrorDetails {
