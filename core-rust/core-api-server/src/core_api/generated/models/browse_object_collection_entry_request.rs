...
pub struct BrowseObjectCollectionEntryRequest {
    ...
    pub module_id: Option<crate::core_api::generated::models::ModuleId>,
    ...
    #[serde(rename = "key")]
    pub key: Option<crate::core_api::generated::models::CollectionEntryKey>, // Using Option permits Default trait; Will always be Some in normal use
}

impl BrowseObjectCollectionEntryRequest {
    pub fn new(network: String, entity_address: String, key: crate::core_api::generated::models::CollectionEntryKey) -> BrowseObjectCollectionEntryRequest {
