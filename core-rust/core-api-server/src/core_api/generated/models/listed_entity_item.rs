...
impl ListedEntityItem {
    pub fn new(entity_address: String, system_type: crate::core_api::generated::models::SystemType, entity_type: crate::core_api::generated::models::EntityType, is_global: bool) -> ListedEntityItem {
        ListedEntityItem {
            entity_address,
            system_type,
            entity_type,
