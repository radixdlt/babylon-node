...
/// GenericTypeParameterContraints : The constraints on the concrete type provided to fill the generic type parameter. Note: currently, we only support the wildcard (i.e. `Any`) generic type. 
...
pub enum GenericTypeParameterContraints {
    #[serde(rename = "Any")]
    Any,

}

impl ToString for GenericTypeParameterContraints {
...
impl Default for GenericTypeParameterContraints {
    fn default() -> GenericTypeParameterContraints {
        Self::Any
    }
}
