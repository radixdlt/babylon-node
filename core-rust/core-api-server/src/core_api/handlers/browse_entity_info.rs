...
pub(crate) async fn handle_browse_entity_info(
    state: State<CoreApiState>,
    Json(request): Json<models::BrowseEntityInfoRequest>,
) -> Result<Json<models::BrowseEntityInfoResponse>, ResponseError<()>> {
    ...
    // the Scrypto repo (e.g. make it a part of `SystemDatabaseBrowser`), and ancestry index is not
    ...
    Ok(models::BrowseEntityInfoResponse {
