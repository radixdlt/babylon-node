...
def generate_rust_models(schema_file, tmp_client_folder, out_location, rust_package):
    ...
    for file_name in file_names:
        ...
        fix_for_enum_not_implementing_default(file_path, "CompositeRequirement")
        fix_for_enum_not_implementing_default(file_path, "BasicRequirement")
        ...
        fix_for_enum_not_implementing_default(file_path, "PreviewTransaction")
