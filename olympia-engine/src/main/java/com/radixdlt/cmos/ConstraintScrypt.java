...
public interface ConstraintScrypt {
  ...
  /**
   * Entrypoint to the constraint scrypt's logic. With the given CMOS interface the smart constraint
   * adds custom application constraints on top of the ledger
   *
